...
var gesturizer = gesturizer || (function ($) {
        ...
        function Gesturizer(settings) {
            ...
            Gesturizer.prototype.startHandler = function (event) {
                ...
                if (this.settings.isIEDevice && (e instanceof MSPointerEvent || e instanceof PointerEvent)) {
            ...
            Gesturizer.prototype.moveHandler = function (event) {
                ...
                if (!this.current.downEvent || this.current.wasPinched) {
                    return false;
                }
            ...
            Gesturizer.prototype.endHandler = function (event) {
                ...
                // if was moved
                    ...
                    if (this.settings.callbacks.swipe || this.settings.callbacks.flick) {
                        ...
                        if (this.settings.callbacks.swipe && timeDiff <= this.settings.timeTreshold.swipe) {
                            var originalStart = this.getAbsolutePosition(this.current.start),
                                originalEnd = this.getAbsolutePosition(this.current.end);
                ...
                if (this.current.multitouch) {
                    this.current.wasPinched = true;
                    setTimeout((function() {
                        this.current.wasPinched = false;
            ...
            Gesturizer.prototype.getAbsolutePosition = function (point) {
